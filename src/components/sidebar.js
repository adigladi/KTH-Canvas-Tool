          ...
          <ul id="menu" className="ic-app-header__menu-list">
              ...
              >
                <div className="menu-item-icon-container" aria-hidden="true">
                  <div className="ic-avatar ">
                    {/* <img
                      src="https://kth.instructure.com/images/thumbnails/523687/OireLtNg9fGdobZ1wdlPq36JznUlp53hvAjGL1Hu"
                      alt="Adrian Berger"
                    /> */}
                  </div>
                </div>
              ...
              >
                <div className="menu-item-icon-container">
                  <span aria-hidden="true">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="ic-icon-svg ic-icon-svg--inbox"
                      version="1.1"
                      x="0"
                      y="0"
                      viewBox="0 0 280 280"
                  ...
                  <span className="menu-item__badge"></span>
                </div>
            ...
            <li className="ic-app-header__menu-list-item">
              <a
                ...
                href="http://help.instructure.com/"
              >
            ...
            <li className="menu-item ic-app-header__menu-list-item">
              ...
              >
                <div className="menu-item-icon-container" aria-hidden="true">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="ic-icon-svg ic-icon-svg--navtoggle"
                    version="1.1"
                    x="0"
                    y="0"
                    width="40"
